...
{
    public class BankAccount : ApiController
    {
        ...
        public IEnumerable<BankAccount> GetBankAccounts()
        {
            ...
            return (IEnumerable<BankAccount>)bankaccounts.AsEnumerable();
        }

        // GET api/BankAccount/5
        public BankAccount GetBankAccount(int id)
        {
            BankAccount bankaccount = (BankAccount)db.BankAccounts.Find(id);
            if (bankaccount == null)
            {
